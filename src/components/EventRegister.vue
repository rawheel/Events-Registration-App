<template>
    <div class="flex flex-wrap content-center bg-gray-900 text-white h-full md:h-screen pt-2">
       <div class="md:grid flex flex-col  md:justify-items-center md:grid-rows-10  md:gap-x-2 m-auto font-sans bg-gray-800 text-gray-900 w-auto mt-20 p-4 md:p-10">
